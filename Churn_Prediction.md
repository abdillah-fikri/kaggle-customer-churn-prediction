...
<!-- #region colab_type="text" id="7goFRawviZgm" -->
## SHIFT ACADEMY
<!-- #endregion -->

<!-- #region colab_type="text" id="64QyQHCMiZgq" -->
# HOMEWORK - Machine Learning
## Customer Churn Prediction
<!-- #endregion -->

<!-- #region colab_type="text" id="HHzFDkG-iZgt" -->
#### Nama : ABDILLAH FIKRI
#### Email : abdillah.fikri14@gmail.com
<!-- #endregion -->

<!-- #region colab_type="text" id="_bsZbYr-iZgu" -->
___
<!-- #endregion -->

<!-- #region colab_type="text" id="0NNo62MqYEsB" -->
# Introduction
<!-- #endregion -->

<!-- #region colab_type="text" id="_REm3p5aWWIK" -->
**About the problems**
...
<!-- #region colab_type="text" id="8A8I2sVcW9Ya" -->
**About the data**
...
<!-- #region colab_type="text" id="pK92zibbXnyR" -->
...
<!-- #region colab_type="text" id="_DvBcP4GZfOi" -->
...
<!-- #region colab_type="text" id="vO2fYxYuagp7" -->
...
<!-- #region colab_type="text" id="rzv9D1RwaNOM" -->
...
<!-- #region colab_type="text" id="cinaWBLQa29h" -->
...
<!-- #region colab_type="text" id="keh7Q_KLlcfU" -->
...
<!-- #region colab_type="text" id="T0Jjf5E6YSjA" -->
Missing values imputation will be done after train test split to avoid information leakage in the test set.
<!-- #endregion -->

<!-- #region colab_type="text" id="pyJmiIzEcUac" -->
# Exploratory Data Analysis
<!-- #endregion -->

<!-- #region colab_type="text" id="EbW7Y8TOcaRq" -->
### Preparation
<!-- #endregion -->

<!-- #region colab_type="text" id="S9w0Dso5AKsU" -->
...
<!-- #region colab_type="text" id="4qu6ouzdcuDD" -->
...
```python colab={"base_uri": "https://localhost:8080/", "height": 34} colab_type="code" executionInfo={"elapsed": 3653, "status": "ok", "timestamp": 1600452217728, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="PAxug4BmaI1N" outputId="6a4793b4-884e-437a-835f-610c9df3b842"
len(num_cols + cat_cols + [target_col])
```

<!-- #region colab_type="text" id="WUtTXtFDdPeC" -->
### Univariate Analysis
<!-- #endregion -->

<!-- #region colab_type="text" id="TFLdLmKjenDr" -->
#### Target Class
<!-- #endregion -->
...
<!-- #region colab_type="text" id="BIlSBGaSfM_O" -->
...
<!-- #region colab_type="text" id="ExwrFABjevVA" -->
#### Numerical Features
<!-- #endregion -->
...
<!-- #region colab_type="text" id="GMPpTIkBAZ3K" -->
...
<!-- #region colab_type="text" id="mYJeOpB2e55a" -->
...
<!-- #region colab_type="text" id="5MEN80vkBDzi" -->
...
<!-- #region colab_type="text" id="m7syQZNJEY10" -->
...
<!-- #region colab_type="text" id="gzIYtsEIwpXp" -->
### Multivariate Analysis
<!-- #endregion -->

<!-- #region colab_type="text" id="3Ks2IjjAEPT8" -->
#### Numerical Features
<!-- #endregion -->
...
<!-- #region colab_type="text" id="jyGA9KRYIjFR" -->
...
```python colab={"base_uri": "https://localhost:8080/", "height": 290} colab_type="code" executionInfo={"elapsed": 7973, "status": "ok", "timestamp": 1600452222365, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="FLybZgE0BsQP" outputId="7bc0cd7a-b137-45a0-8257-a830e131de4b"
plt.figure(figsize=(15,4))
for i, col in enumerate(num_cols):
  plt.subplot(1,3,i+1)
...
<!-- #region colab_type="text" id="300x3lqYBcZ5" -->
...
<!-- #region colab_type="text" id="NXVUF3GQESPk" -->
#### Categorical Features
<!-- #endregion -->
...
<!-- #region colab_type="text" id="yHvFDSaOb6BP" -->
...
<!-- #region colab_type="text" id="e9JkMygff8vA" -->
...
<!-- #region colab_type="text" id="bVQp2skJMwuP" -->
#### Features Corelation
<!-- #endregion -->
...
```python colab={"base_uri": "https://localhost:8080/", "height": 432} colab_type="code" executionInfo={"elapsed": 11500, "status": "ok", "timestamp": 1600452226022, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="feKdg6Qlw_Gp" outputId="5fffe577-b036-4eaf-bb67-bfbce525c34a"
...
<!-- #region colab_type="text" id="GWtU2JXVNLe5" -->
...
<!-- #region colab_type="text" id="FjVrOGZoXbJX" -->
...
<!-- #region colab_type="text" id="b4gZByzckAiq" -->
# Data Processing
<!-- #endregion -->

<!-- #region colab_type="text" id="z1qC2j_9l5g-" -->
### Train Test Split
<!-- #endregion -->
...
<!-- #region colab_type="text" id="eRdNLqcem-r1" -->
### Outlier Handling
<!-- #endregion -->

<!-- #region colab_type="text" id="NpYZJHzqVnuf" -->
...
<!-- #region colab_type="text" id="-0pZQ8BWqTSK" -->
...
<!-- #region colab_type="text" id="bBRXlxdeqTST" -->
...
<!-- #region colab_type="text" id="3hqGYNEwoIIq" -->
...
<!-- #region colab_type="text" id="1tm06lSIRE6L" -->
...
<!-- #region colab_type="text" id="UaK-U9kWwL4f" -->
### Feature Enginering
<!-- #endregion -->

<!-- #region colab_type="text" id="yqPqcZjkTRCi" -->
...
```python colab={} colab_type="code" id="jgrh9kRzvbQd"
...
<!-- #region colab_type="text" id="s9cTjvKoSEyw" -->
...
<!-- #region colab_type="text" id="AkRo-_aFsemH" -->
...
<!-- #region colab_type="text" id="1geqxzn4r25t" -->
### Scaling
<!-- #endregion -->
...
```python colab={} colab_type="code" id="RjKfqo8q1ACH"
...
<!-- #region colab_type="text" id="frcunsSfrz27" -->
# Modeling
<!-- #endregion -->

<!-- #region colab_type="text" id="wx_gfElHThfc" -->
...
<!-- #region colab_type="text" id="DzmAfCINXhwl" -->
...
<!-- #region colab_type="text" id="xPAoQUGmxeoA" -->
### Preparation
<!-- #endregion -->
...
<!-- #region colab_type="text" id="pc5Roz_OxzrD" -->
### Model Fitting and Evaluation
<!-- #endregion -->

<!-- #region colab_type="text" id="tQtnxdDuyDEv" -->
#### Logistic Regression
<!-- #endregion -->
...
<!-- #region colab_type="text" id="HUWT6Vqwx86R" -->
#### Desicion Tree
<!-- #endregion -->
...
<!-- #region colab_type="text" id="SXdRTXCpyD-9" -->
#### K-Neirest Neighbors
<!-- #endregion -->
...
<!-- #region colab_type="text" id="d4oSlPdVyEj9" -->
#### XGBoost Classifier
<!-- #endregion -->
...
<!-- #region colab_type="text" id="5b5d5mbIXGGg" -->
**Summary**:
...
```python colab={"base_uri": "https://localhost:8080/", "height": 34} colab_type="code" executionInfo={"elapsed": 37041, "status": "ok", "timestamp": 1600326461592, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="IVJqixKa2Qi5" outputId="3bf6125e-243b-4620-82e1-6a8f7a90d72f"
...
```python colab={"base_uri": "https://localhost:8080/", "height": 34} colab_type="code" executionInfo={"elapsed": 32415, "status": "ok", "timestamp": 1600326678668, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="4KsKxFvQ2P2l" outputId="b5368b4e-223f-4c3e-f761-7055aedf3edf"
...
```python colab={"base_uri": "https://localhost:8080/", "height": 170} colab_type="code" executionInfo={"elapsed": 3355328, "status": "ok", "timestamp": 1600369018634, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="P7GhGUHMVSGd" outputId="091d868e-1545-4c33-feed-70c60176dc69"
params = {'max_depth': range(3,10,2),
         'min_child_weight': range(1,6,2),
         'gamma': [i/10.0 for i in range(0,5)],
         'subsample':[i/10.0 for i in range(6,10)],
...
<!-- #region colab_type="text" id="GmDteUcXz1rx" -->
### Model with Weighted Parameter
<!-- #endregion -->

<!-- #region colab_type="text" id="nzmuYqNmzRFD" -->
#### Logistic Regression
<!-- #endregion -->
...
```python colab={"base_uri": "https://localhost:8080/", "height": 622} colab_type="code" executionInfo={"elapsed": 24001, "status": "ok", "timestamp": 1600452252555, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="mywXBHdNzZ6Y" outputId="2f083adf-a1a8-4be2-a621-82c8c1787b67"
test_eval(lr_cw, X_test_sc, y_test)
```

<!-- #region colab_type="text" id="peU9EsMF5Pdy" -->
##### Hyperparameter Tunning
<!-- #endregion -->
...
<!-- #region colab_type="text" id="9Rkmop0IzQ0E" -->
#### XGBoost Classifier
<!-- #endregion -->
...
<!-- #region colab_type="text" id="dLmkhbhlxtFt" -->
##### Hyperparameter Tunning
<!-- #endregion -->
...
```python colab={} colab_type="code" id="Dkb8RNE3GgQd"
...
<!-- #region colab_type="text" id="90PTmrQQqTUp" -->
**Summary:**
...
<!-- #region colab_type="text" id="2imQAu646BR8" -->
...
<!-- #region colab_type="text" id="uT1vLaGL0Y6J" -->
#### Logistic Regression
<!-- #endregion -->
...
```python colab={"base_uri": "https://localhost:8080/", "height": 622} colab_type="code" executionInfo={"elapsed": 34402, "status": "ok", "timestamp": 1600452291945, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="iBY_OJS70gaI" outputId="a8032cab-6120-4feb-8089-f347a716f6a4"
test_eval(lr, X_test, y_test)
```

<!-- #region colab_type="text" id="KtjbGrbf5ZKm" -->
##### Hyperparameter Tunning
<!-- #endregion -->
...
<!-- #region colab_type="text" id="kQZHotIf0boP" -->
#### XGBoost Classifier
<!-- #endregion -->
...
<!-- #region colab_type="text" id="WUhHxUmdqjje" -->
**Summary:**
